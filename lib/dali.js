...
//	this.ModbusTcpMutex = new mutex.Mutex();
...
//console.log("call setNewLevel from counterObject");
//console.log("device min: "+await device.getMinLevel());
//console.log("old: "+levelOld+", new:"+levelNew);
                            await device.setLevelDali(levelNew);
                            this.adapter.log.debug('Level changed to ' + levelNew + ' for ' + device.getPath());
                            //this.adapter.log.debug('levelDali: '+await device.getLevelDali()+', levelHa: '+await device.getLevelHa());
                            await this.adapter.onDaliLevelChanged(device);
                            //this.adapter.setState(device.getPath(), device.getLevelHa());
//                            this.responseState(device.getLevelHa(), name, path + name);
                        }
                }
